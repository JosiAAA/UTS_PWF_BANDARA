...
<div class="content">
<div class="container">
<h2 class="mb-5">Daftar Tiket</h2>
<div class="table-responsive">
<table class="table table-striped custom-table">
    <a href="/tambahTiket" class="btn btn-primary">
...
<tbody>
    ...
    <tr scope="row">
        ...
        <td><a href="/editTiket/{{ $p->id }}" class="btn btn-primary" style="color: white; background-color: transparent;">Edit</a></td>
        <td><a href="/hapusTiket/{{ $p->id }}" class="btn btn-primary delete-button" style="color: white; background-color: transparent;">Delete</a></td>
