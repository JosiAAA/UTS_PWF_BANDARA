...
<table class="table table-striped custom-table">
    <a href="/tambahPenumpang" class="btn btn-primary">
...
<tbody>
    ...
    <tr scope="row">
        ...
        <td><a href="/edit/{{ $p->id }}" class="btn btn-primary" style="color: white; background-color: transparent;">Edit</a></td>
        <td><a href="/hapus/{{ $p->id }}" class="btn btn-primary delete-button" style="color: white; background-color: transparent;">Delete</a></td>
