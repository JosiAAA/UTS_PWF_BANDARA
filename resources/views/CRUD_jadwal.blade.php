...
<table class="table table-striped custom-table">
    <a href="/tambahJadwal" class="btn btn-primary">
...
<tbody>
    ...
    <tr scope="row">
        ...
        <td><a href="/editJadwal/{{ $p->id }}" class="btn btn-primary" style="color: white; background-color: transparent;">Edit</a></td>
        <td><a href="/hapusJadwal/{{ $p->id }}" class="btn btn-primary delete-button" style="color: white; background-color: transparent;">Delete</a></td>
